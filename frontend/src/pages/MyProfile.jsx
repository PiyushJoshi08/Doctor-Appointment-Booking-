...
//select and options tag to limit choices the user can change something to and use onchange to propogate the change
...
const MyProfile = () => {
  ...
  const [userData,setUserData]=useState({ //initialized with an object
    ...
    phone:"7668498607",
    address:{ //also an object
      line1:"Aquamarine Hostel",
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm '>
      ...
      { //agar isedit true hai toh input krne ka show krega otherwise name show krega
        isEdit
        ? <input className='bg-gray-50 text-3xl font-medium max-w-60 mt-4' type="text" value={userData.name} onChange={e=>setUserData(prev =>({...prev,name:e.target.value}))}/> //this is used to edit the previous data, here e is ths event
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {
          isEdit
          ? <input className='bg-gray-100 max-w-52' type="text" value={userData.phone} onChange={e=>setUserData(prev =>({...prev,phone:e.target.value}))}/> //this is used to edit the previous data, here e is ths event
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {
            isEdit
            ? <input type="date" className='max-w-28 bg-gray-100' onChange={(e)=>setUserData(prev =>({...prev,gender:e.target.value}))} value={userData.dob}/>
